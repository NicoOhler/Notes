...
+ Beispiel
	+ ![](Pasted%20image%2020220314130508.png)
	+ ![](Pasted%20image%2020220314131029.png)
...
+ Beispiel: dreidimensionale Polarkoordinaten
	...
	+ Bedingungen
		...
		+ 0≤ψ≤π
		+ 0≤φ≤2π
	+ ![](Pasted%20image%2020220314132808.png)
	+ Beispiel: Polarkoordinaten bei Kugel
		+ ![](Pasted%20image%2020220314143710.png)
+ Zylinderkoordinaten
	+ x ==> rcos(φ)
	+ y ==> rsin(φ) 
	+ z ==> z
	+ Volumenselement
		+ $dxdydz=rdrdφdz$
	+ Beispiel
		+  ![](Pasted%20image%2020220314145659.png)
		+  ![](Pasted%20image%2020220314145710.png)
