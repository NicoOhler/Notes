...
+ ![](Pasted%20image%2020240115170331.png)
+ birthday paradox
...
+ key-alternating using key schedule
	...
	+ e.g. AES
		+ ![](Pasted%20image%2020240115093758.png)
		+ SubBytes
		...
		+ MixColumns
			...
			+ ![](Pasted%20image%2020240115094429.png)
		+ AddRoundKey
			+ XOR with $k^{(r)}$
			+ $b_{ij} = a_{ij}⊕k^{(r)}$
+ regular encryption
	...
	+ ECB
		+ ![](Pasted%20image%2020240115094730.png)
		+ ![](Pasted%20image%2020240115094743.png)
	+ CBC
		+ ![](Pasted%20image%2020240115094825.png)
		+ C also depends on nonce and previous blocks
	+ CTR
		+ ![](Pasted%20image%2020240115094928.png)
	...
	+ Authenticated Encryption (with Associated Data)
		...
		+ some TLS 1.3 authenticated ciphers
			+ AES-CCM (CTR using AES encryption with CBC-MAC authentication)
				+ ![](Pasted%20image%2020240115095527.png)
			+ AES-GCM (default)
+ Asymmetric encryption schemes
	+ Preliminary maths
		...
		+ ![](Pasted%20image%2020240115100753.png)
		+ ![](Pasted%20image%2020240115100804.png)
		+ ![](Pasted%20image%2020240115101326.png)
		+ ![](Pasted%20image%2020240115101307.png)
	+ Key exchange
	...
	+ Asymmetric encryption
		...
		+ RSA
			+ ![](Pasted%20image%2020240115101959.png)
			...
			+ textbook RSA is deterministic
				+ use padding scheme
				+ ![](Pasted%20image%2020240115102437.png)
				+ e.g. RSAES-OAEP
...
+ Transport Layer Security TLS
	+ Key exchange using DHE
		...
		+ ![](Pasted%20image%2020240115103730.png)
	+ Authentication
		...
		+ ![](Pasted%20image%2020240115104150.png)
...
+ Kerckhoffs' Principle
	+ ![](Pasted%20image%2020240115171311.png)
	+ ![](Pasted%20image%2020240115171327.png)
+ Elliptic Curve Cryptography ECC
	+ ![](Pasted%20image%2020240115104641.png)
+ End-to-End Encryption
	+ may require more security properties
		+ ![](Pasted%20image%2020240115104730.png)
