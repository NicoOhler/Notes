...
+ many algorithms can be applied to unweighted trees
	...
	+ [[../Datenstrukturen und Algorithmen/Datenstrukturen/Graphs/Breadth-First Search]]
	+ [[../Datenstrukturen und Algorithmen/Datenstrukturen/Graphs/Depth-First Search]]
	+ …
...
+ greedy
+ also works with negative weights
+ uses [[../Datenstrukturen und Algorithmen/Datenstrukturen/Union Find]] data structure
