...
+ used data structures
	+ X
		...
		+ operations
			+ insert
			+ remove $x$-minimum
				+ [[../Datenstrukturen/Queue]], [[../Datenstrukturen/Heap]]
	+ search tree Y
		...
		+ operations
			...
			+ dictionary, [[../Datenstrukturen/Bäume/(2-4)-Bäume]]
+ pseudocode
...
+ at most two new neighbours
	...
	+ easier to find if linked
		+ maybe link leaves of [[../Datenstrukturen/Bäume/(2-4)-Bäume]] with pointers
